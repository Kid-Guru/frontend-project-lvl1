		...
		<header>
			<div className={s.container}>
				<div className={s.header}>
					<button className={s.btn + ' ' + s.btn_burger} aria-label="открыть меню">
						<svg focusable="false" className={s.svg_icon} width="24" height="24" viewBox="0 0 24 24" fill="none"
					...
					<form className={s.search} method="get" action="goods.html">
						<input type="search" name="s" maxLength="150" className={s.search_input} spellCheck="false"
						...
						<button type="submit" className={`${s.btn} ${s.search_btn}`} aria-label="найти"></button>
					</form>
					<a href="goods.html?cat=wishlist" className={`${s.btn} ${s.btn_wishlist}`}>
						<svg focusable="false" className={s.svg_icon} width="24" height="24" viewBox="0 0 24 24" fill="none"
							xmlns="http://www.w3.org/2000/svg">
